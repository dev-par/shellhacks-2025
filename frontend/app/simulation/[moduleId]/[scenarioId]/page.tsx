  ...
  "emergency-triage": {
    1: {
      ...
      patient: {
        ...
        age: 34,
        gender: "Female",
        chiefComplaint: "Motor vehicle accident with chest pain and difficulty breathing",
        vitals: {
          heartRate: 110,
          bloodPressure: "90/60",
          temperature: 98.2,
...
function SimulationContent() {
  ...
  const [currentPhase, setCurrentPhase] = useState<"assessment" | "diagnosis" | "treatment">("assessment")
  ...
  const scenario = scenarioData[moduleId as keyof typeof scenarioData]?.[scenarioId]
  ...
  const progress = (timeElapsed / (scenario.duration * 60)) * 100
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                <Link href={`/modules/${moduleId}`} className="text-muted-foreground hover:text-foreground">
              ...
              <div className="flex items-center space-x-6">
                ...
                <Badge variant={currentPhase === "assessment" ? "default" : "secondary"}>
                ...
                <CardContent className="space-y-4">
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {scenario.patient.age} years old, {scenario.patient.gender}
                    </p>
                  </div>

                  <div>
                    <h5 className="font-medium text-sm mb-2">Chief Complaint</h5>
                    <p className="text-sm text-muted-foreground">{scenario.patient.chiefComplaint}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        <span>BP:</span>
                        <span>{scenario.patient.vitals.bloodPressure} mmHg</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="flex items-center">
                      ...
                      <div className="flex justify-between">
                        <span>RR:</span>
                        <span>{scenario.patient.vitals.respiratoryRate}/min</span>
                      </div>
                      <div className="flex justify-between">
                        <span>O2 Sat:</span>
                        <span className="text-yellow-600">{scenario.patient.vitals.oxygenSaturation}%</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {scenario.patient.allergies.map((allergy, index) => (
                  ...
                  <div>
                    ...
                    <ul className="text-sm text-muted-foreground space-y-1">
                      {scenario.patient.medications.map((med, index) => (
                        <li key={index}>• {med}</li>
                      ))}
                    </ul>
                  </div>
                  ...
                  <div>
                    <h5 className="font-medium text-sm mb-2">Medical History</h5>
                    <ul className="text-sm text-muted-foreground space-y-1">
                      {scenario.patient.medicalHistory.map((history, index) => (
                ...
                <CardContent className="flex-1 flex flex-col">
                  ...
                  <div className="flex-shrink-0 border-t border-border pt-4">
                    ...
                    <div className="flex items-center justify-between mt-3 text-xs text-muted-foreground">
                      <span>
                        {lastTranscription
                          ? `Transcribed: "${lastTranscription.substring(0, 50)}..."`
