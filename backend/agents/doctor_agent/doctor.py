...
doctor_agent = Agent(
        ...
        description="SENIOR DOCTOR AGENT who handles the SBAR consultation.",
        ...
        "Use the 'feedback_report' tool to provide a feedback to the trainee in expected JSON format.",

        tools=[get_trainee_report, feedback_report],
)

def get_trainee_report(trainee_report: str) -> str:
    return trainee_report

def feedback_report(feedback: str) -> str:
    """
